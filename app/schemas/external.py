...
finance_v2(Spring) ↔ FastAPI 통신 규격. 내부 ChatRequest/ChatResponse 와 분리해
어댑터(app/services/contract.py)가 양쪽을 번역한다. 명세: 연동 명세서 v2.0
(POST /api/v1/chat, 동기 JSON, X-Trace-Id echo).
"""
